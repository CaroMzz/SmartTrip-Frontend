      ...
      <section className="verification-section">
        <div className="verification-container">
          ...
          <p className="verification-message">
            Te enviamos un enlace a florencia@ejemplo.com. Abrilo para verificar
            tu cuenta y empezar a planificar.
          </p>

          <div className="verification-actions">
            <button type="button" className="verification-button primary">
